    ...
    <div class="overflow-scroll" style="height: 50dvh">
        <table class="table table-bordered table-hover text-center border-dark" style="width :300%">
            ...
            <tr>
                ...
                <td style="outline: none ; border:none;"><a href="{{route('droittimbre.destroy' , $droittimber)}}" class="btn btn-danger" onclick="return confirm('Vous-etre sure de supprimer cette donnée?')">supprimer</a></td>
                <td style="outline: none ; border:none;"><a href="{{route('droittimbre.update' , $droittimber)}}" class="btn btn-primary">modifier</a></td>
            </tr>
            @empty
                @php
                    $empty=true;
